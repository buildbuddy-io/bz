...
def _get_analysis_input_artifacts(ctx, artifacts: ArtifactTSet) -> dict[ConfiguredProvidersLabel, list[_AnalysisInput]]:
...
def _analyze_artifacts(
        ...
        label_to_artifacts: dict[ConfiguredProvidersLabel, list[_AnalysisInput]]) -> dict[ConfiguredProvidersLabel, list[Artifact]]:
    label_to_analysis = {}
...
def _reduce_analysis_artifacts(
        ...
        label_to_artifacts: dict[ConfiguredProvidersLabel, list[Artifact]]) -> Artifact:

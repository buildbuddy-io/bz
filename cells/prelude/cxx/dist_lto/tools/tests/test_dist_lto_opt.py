...
class TestDistLtoOpt(unittest.TestCase):
    def test_filter_flags(self):
        inputs = [
            ...
            "-Wl,-plugin-opt,sample-profile=/workspace/abc/autofdo.profile",
        ...
        self.assertListEqual(
            ...
            [
                ...
                "-fprofile-sample-use=/workspace/abc/autofdo.profile",
                "-mllvm",
                "-llvm-flag2",
                "-O3",
                "-mllvm",
    ...
    def test_fbcc_prefix_end_tp2_with_log_fbcc(self):
        ...
        opt_args = [
            "--",
            "buck-out/fbcc",
            "--cc=workspace/third-party-buck/platform010/build/llvm-fb/19/bin/clang++",
            "--log-fbcc=False",
    ...
    def test_fbcc_prefix_end_buckified_no_log_fbcc(self):
        ...
        opt_args = [
            "--",
            "buck-out/fbcc",
            "--cc=buck-out/v2/art/workspace/third-party/llvm-fb/19/__build/bin/clang++__/out/clang++",
            "--target=x86_64-redhat-linux-gnu",
            "-nostdinc",
            "-nostdinc++",
        ]
    ...
    def test_filter_flags_hhvm_case_rev_0f8618f31(self):
        inputs = [
            ...
            "-idirafter",
            "-idirafter",
            "workspace/third-party-buck/platform010/build/glibc/include",
            "-idirafter",
            "workspace/third-party-buck/platform010/build/kernel-headers/include",
            "-Bworkspace/third-party-buck/platform010/build/binutils/x86_64-facebook-linux/bin",
            "--cflag=--target=x86_64-redhat-linux-gnu",
            "-Bworkspace/third-party-buck/platform010/build/glibc/lib",
            "-Bworkspace/third-party-buck/platform010/tools/gcc/lib/gcc/x86_64-redhat-linux-gnu/trunk",
            "-Lworkspace/third-party-buck/platform010/build/libgcc/lib/gcc/x86_64-facebook-linux/trunk",
            "-Wl,-nostdlib",
            "-Wl,--dynamic-linker,/usr/local/workspace/platform010/lib/ld.so",
            "-Wl,--disable-new-dtags",
            "-Bworkspace/third-party-buck/platform010/build/binutils/x86_64-facebook-linux/bin",
            "-Wl,--no-mmap-output-file",
            "-nodefaultlibs",
            "--target=x86_64-redhat-linux-gnu",
            "-Lworkspace/third-party-buck/platform010/build/glibc/lib",
            "-Lworkspace/third-party-buck/platform010/build/libgcc/lib",
            "-Wl,-z,notext",
            "-Wl,-z,relro",
            "-Wl,--gc-sections",
            "-fuse-ld=lld",
            ...
            "workspace/tools/build/move_gpu_sections_implicit_linker_script.txt",
            "-fuse-ld=lld",
            "--build-info=full",
            ...
            "--build-info-rule=workspace:scripts/fnz/minimal:minimal",
    ...
    def test_filter_flags_unicorn_case_rev_0f8618f31(self):
        inputs = [
            ...
            "--build-info-platform=platform010",
            "--build-info-rule=workspace:unicorn:index_server",
            "--build-info-rule-type=cpp_binary",
            "-flto=thin",
            "-Wl,-plugin-opt,sample-profile=buck-out/v2/gen/workspace/40fc99293b37c503/fdo/autofdo/default_profile/__autofdo__/out/profile",
            "-Wl,-plugin-opt,-function-sections",
            "-Wl,-plugin-opt,-profile-guided-section-prefix=false",
            "-Wl,-plugin-opt,-generate-type-units",
            "-Wl,-plugin-opt,-enable-lto-ir-verification=false",
            ...
            "-Xlinker",
            "--start-group",
            "workspace/third-party-buck/platform010/build/IntelComposerXE/mkl/lib/intel64/libmkl_intel_lp64.a",
            "workspace/third-party-buck/platform010/build/IntelComposerXE/mkl/lib/intel64/libmkl_core.a",
            "workspace/third-party-buck/platform010/build/IntelComposerXE/mkl/lib/intel64/libmkl_intel_thread.a",
            "-Xlinker",
            "--end-group",
            "-lpthread",
            "-Xlinker",
        ...
        self.assertListEqual(
            ...
            [
                ...
                "-fdata-sections",
                "-fuse-ld=lld",
                "-fprofile-sample-use=buck-out/v2/gen/workspace/40fc99293b37c503/fdo/autofdo/default_profile/__autofdo__/out/profile",
                "-mllvm",
                "-profile-guided-section-prefix=false",
                "-mllvm",
                "-generate-type-units",

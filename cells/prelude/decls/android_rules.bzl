...
#    }
REMOTE_EXECUTION_EXTRA_PARAMS = attrs.option(attrs.dict(key = attrs.string(), value = attrs.any()), default = None)
...
Use this attribute to resolve duplicate classes when one provider can be excluded from DEX."""),
...
keystore = prelude_rule(
    ...
    docs = """
        ...
        with the JDK. This is a required input for an `android_binary()` rule.
    """,
    examples = None,
    further = None,
    attrs = (

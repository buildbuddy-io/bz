...
cc_toolchain = prelude_rule(
    ...
    attrs = {
        ...
        "coverage_files": attrs.option(attrs.dep(), default = None),
        ...
        "dynamic_runtime_lib": attrs.option(attrs.dep(), default = None),
        "module_map": attrs.option(attrs.source(), default = None),
        "static_runtime_lib": attrs.option(attrs.dep(), default = None),

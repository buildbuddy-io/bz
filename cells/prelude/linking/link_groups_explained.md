...
which are typically generated by the workspace macro based on the link group map.
...
```
link_group_map = [
    ("group_a", [(":root", "tree", "pattern:root//vendor/...", None)]),
]
...
```python
link_group_map = [
    ("caffe2", [(None, "tree", "pattern:root//caffe2/...", None)]),
    ("velox",  [(None, "tree", "pattern:root//velox/...", None)]),
]
```
...
```python
link_group_map = [
    ("libs", [(None, "subfolders", "pattern:root//large_dep/...", None)]),
]
```
...
link_group_map = [
    ...
    ("everything_else", [(None, "tree", "pattern:root//...", None)]),
]
```

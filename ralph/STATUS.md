...
_Last updated: 2026-06-17 09:25 UTC_
...
huge multi-language repo. **27 `bz` bugs found, fixed, verified, and committed; 9
...
| F38 | `data` files absent from cc_test runfiles | core runfiles collection; blocks tests with fixtures |
...
| boringssl | rules_cc + asm (real-world crypto) | ✅ crypto (369 actions, x86 asm) + ssl_test build+pass (471 tests) after F37; crypto_test data-fixtures blocked by F38 |

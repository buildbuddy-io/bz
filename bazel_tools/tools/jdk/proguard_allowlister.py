...
binary through a library dependency."""
    ...
    parser.add_argument("--path", required=True, help="Path to the proguard config to validate")
    parser.add_argument("--output", required=True, help="Where to put the validated config")

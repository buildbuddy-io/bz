...
# to repro uncomment and run `buck2 test '@root//mode/opt-asan' //tests/e2e/build:test_paranoid -- --exact 'buck2/tests/e2e/build:test_paranoid - test_paranoid.py::test_paranoid_allows_fallback_after_re_failure' --run-disabled`
# @buck_test(
...
# TODO(T184317763): either those tests are flaky or paranoid mode is broken,
# to repro uncomment and run `buck2 test '@root//mode/opt-asan' //tests/e2e/build:test_paranoid -- --exact 'buck2/tests/e2e/build:test_paranoid - test_paranoid.py::test_paranoid_forces_fallback_on_failure' --run-disabled`
# @buck_test(
#     data_dir="execution_platforms",
#     skip_for_os=["windows"],
# )

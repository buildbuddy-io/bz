...
use crate::interpreter::rule_defs::provider::builtin::bazel::cc_info::register_cc_common;
use crate::interpreter::rule_defs::provider::builtin::bazel::coverage_info::register_coverage_common;
use crate::interpreter::rule_defs::provider::builtin::bazel::java_info::register_java_common;
use crate::interpreter::rule_defs::provider::builtin::bazel::template_variable_info::register_platform_common;
use crate::interpreter::rule_defs::provider::builtin::bazel::testing::register_bazel_testing;

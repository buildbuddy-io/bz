...
use bz_build_api::interpreter::rule_defs::transitive_set::globals::register_transitive_set_types;
...
use crate::interpreter::transitive_set::testing::tset_factory;
...
#[test]
fn test_define_transitive_set() -> bz_error::Result<()> {
...
#[test]
fn test_hash_transitive_set() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_define_transitive_set_projections() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_create_transitive_set() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_frozen_transitive_sets() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_transitive_set_display() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_transitive_sets_projection() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_transitive_sets_iteration() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_frozen_transitive_sets_iteration() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_projection_args() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_projection_inputs() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_projection_iteration() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_json_projection() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_reduction() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_definition_type() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_type_1() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_type_2() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
    let contents = indoc!(
        r#"
        FooSet = transitive_set()
...
#[test]
fn test_transitive_set_ordering_docs() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();
...
#[test]
fn test_accessors() -> bz_error::Result<()> {
    let mut tester = transitive_set_tester();

...
pub fn total_cache_hit_rate(
    ...
    remote_actions: u64,
    cached_actions: u64,
    local_cached_actions: u64,
    remote_dep_file_cached_actions: u64,
) -> f64 {
    let total_actions = local_actions
        + remote_actions
        + cached_actions
        + local_cached_actions
        + remote_dep_file_cached_actions;
    let total_cached_actions =
        cached_actions + local_cached_actions + remote_dep_file_cached_actions;

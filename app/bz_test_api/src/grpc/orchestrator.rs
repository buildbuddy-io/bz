...
/// Test runner client to bz test orchestrator.
///
/// When running `bz test`, bz starts a gRPC server
/// and spawns a test runner which connects to bz process using this client.

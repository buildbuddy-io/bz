...
impl LoadedModule {
    ...
    pub fn extra_globals_from_prelude_for_buck_files(
        &self,
    ) -> bz_error::Result<impl Iterator<Item = (&str, FrozenValue)> + '_> {
...
impl InterpreterFileLoader {
    ...
    fn find_module(&self, id: StarlarkModulePath) -> bz_error::Result<&FrozenModule> {
...
mod tests {
    ...
    impl LoadResolver for TestLoadResolver {
        fn resolve_load(
            ...
            match path {
                ...
                _ => Err(bz_error!(bz_error::ErrorTag::Tier0, "error")),
            }
        }
    }
    ...
    #[test]
    fn no_resolution() -> bz_error::Result<()> {
    ...
    #[test]
    fn missing_in_loaded_modules() -> bz_error::Result<()> {

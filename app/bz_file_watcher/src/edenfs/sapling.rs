    ...
    fn test_hg_status_line() -> buck2_error::Result<()> {
        assert_eq!(
            ...
            Some((
                ...
                "buck2/app/bz_file_watcher/src/edenfs/sapling.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("A buck2/app/bz_file_watcher/src/edenfs/interface.rs")?,
            Some((
                SaplingStatus::Added,
                "buck2/app/bz_file_watcher/src/edenfs/interface.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("R buck2/app/bz_file_watcher/src/edenfs/utils.rs")?,
            Some((
                SaplingStatus::Removed,
                "buck2/app/bz_file_watcher/src/edenfs/utils.rs".to_owned()
            ))
        );

        assert_eq!(
            process_one_status_line("! buck2/app/bz_file_watcher/src/edenfs/sapling.rs")?,
            Some((
        ...
        assert_eq!(
            process_one_status_line("C buck2/app/bz_file_watcher/src/edenfs/sapling.rs")?,
            Some((
                SaplingStatus::Clean,
                "buck2/app/bz_file_watcher/src/edenfs/sapling.rs".to_owned()
            ))
        ...
        assert_eq!(
            process_one_status_line("I buck2/app/bz_file_watcher/src/edenfs/sapling.rs")?,
            Some((
        ...
        assert!(
            process_one_status_line("Mbuck2/app/bz_file_watcher/src/edenfs/sapling.rs").is_err()
        );
